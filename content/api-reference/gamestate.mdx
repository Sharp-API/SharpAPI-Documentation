...
- [Events](/api-reference/events) — List events with filtering
- [Event Details](/api-reference/events-by-id) — Get details for a specific event
- [Odds Snapshot](/api-reference/odds) — Get odds with live game state fields
- [SSE Stream](/api-reference/stream) — Real-time streaming (supports `?channel=gamestate`)
