...
| `market` | string | all | Filter by market type(s), comma-separated. Supports category aliases — see [Odds: Market Category Aliases](/api-reference/odds#market-category-aliases). |
