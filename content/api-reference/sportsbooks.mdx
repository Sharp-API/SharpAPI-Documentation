...
<Callout type="info">
**Building a live betting tool?** DraftKings and FanDuel have `has_live_odds: true` but frequently suspend markets during scoring plays and key moments. If you need continuous live coverage, Pinnacle (Sharp tier) is the reliable reference. See [Live vs. Pre-Match](/concepts/live-vs-prematch) for a full breakdown of book behavior during live play.
</Callout>
