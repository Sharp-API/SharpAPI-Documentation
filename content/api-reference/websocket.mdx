...
| `sport` | string | Filter by sport(s), comma-separated (e.g. `basketball`, `football`, `ice_hockey`) |
...
3. **Use filters** -- Pass `sport`, `sportsbook`, and `league` params to narrow data within your subscribed channels
