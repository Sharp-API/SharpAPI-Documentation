---
description: "How SharpAPI matches events across sportsbooks using canonical event IDs. Solves the problem of different sportsbook-specific event identifiers."
---
