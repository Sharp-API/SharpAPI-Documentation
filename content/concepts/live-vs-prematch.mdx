...
- [Odds Snapshot](/api-reference/odds) — `live` query parameter reference
- [Sportsbooks](/api-reference/sportsbooks) — Full book list with `has_live_odds` and tier requirements
- [+EV Opportunities](/api-reference/opportunities-ev) — Pre-computed +EV using Pinnacle as the sharp reference
