...
| `odds:update` | Kompaktes Delta — nur dynamische Felder (`id`, `odds_american`, `odds_decimal`, `odds_probability`, `line`, `is_live`, `timestamp`). Per `id` in den Snapshot-Zustand einfügen. |
