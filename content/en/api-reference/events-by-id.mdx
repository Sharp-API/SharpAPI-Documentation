...
- **Cross-book comparison** -- The canonical `id` is the same across all sportsbooks, so all odds returned are already matched to the same real-world event. See [Event Matching](/en/concepts/event-matching).
...
- [Event Odds](/en/api-reference/events-odds) - Get paginated odds for this event
- [Event Markets](/en/api-reference/events-markets) - Get available market types for this event
