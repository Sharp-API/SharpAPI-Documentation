...
<Callout type="info">
Use this endpoint to check market availability before calling [Event Odds](/en/api-reference/events-odds) with a `market` filter. This avoids wasting API calls on market types that do not exist for a given event.
</Callout>

## Related Endpoints

- [Events](/en/api-reference/events) - List and search events
- [Event Details](/en/api-reference/events-by-id) - Get event details with embedded market data
- [Event Odds](/en/api-reference/events-odds) - Get all odds for this event
- [Markets](/en/api-reference/markets) - List all market types across the platform
