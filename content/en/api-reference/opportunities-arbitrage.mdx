...
| `market` | string | all | Filter by market type(s), comma-separated. Supports category aliases — see [Odds: Market Category Aliases](/en/api-reference/odds#market-category-aliases). |
...
<Callout type="info">
Many experienced bettors prefer +EV betting over arbitrage because accounts last longer and the expected edges are often larger. See the [+EV Opportunities](/en/api-reference/opportunities-ev) endpoint for details.
</Callout>
...
- [Arbitrage Concepts](/en/concepts/arbitrage) - Detailed arbitrage theory
- [Arbitrage Scanner Example](/en/examples/arbitrage-scanner) - Build a real-time scanner
