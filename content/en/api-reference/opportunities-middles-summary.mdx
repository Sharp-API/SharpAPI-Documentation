...
Get aggregate statistics for current middle opportunities without the full list. Uses the same underlying data as the [Middles](/en/api-reference/opportunities-middles) endpoint.
...
Poll the summary endpoint at shorter intervals to detect when new opportunities appear, then fetch the full [Middles](/en/api-reference/opportunities-middles) endpoint only when the count changes.
...
- [Middles](/en/api-reference/opportunities-middles) — Full list of middle opportunities
