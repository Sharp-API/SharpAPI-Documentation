---
description: "Complete SharpAPI v1 REST API reference. Covers authentication, pagination, filtering, error handling, and conventions used across all endpoints."
---
