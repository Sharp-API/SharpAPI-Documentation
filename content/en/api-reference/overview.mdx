...
| `GET` | `/api/v1/historical/odds/movements` | Yes | Enterprise |
| `GET` | `/api/v1/historical/odds/closing` | Yes | Enterprise |
| `GET` | `/api/v1/historical/opportunities` | Yes | Enterprise |
| `GET` | `/api/v1/historical/opportunities/:id` | Yes | Enterprise |
| `GET` | `/api/v1/historical/summary` | Yes | Enterprise |
| `GET` | `/api/v1/historical/clv` | Yes | Enterprise |
...
|---------|------|-------|-----|-------|------------|
| **Sportsbooks** | 2 (DK, FD) | 5 | 15 | All 30+ | All 30+ |
