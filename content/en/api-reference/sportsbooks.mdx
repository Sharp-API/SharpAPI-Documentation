---
description: "GET /api/v1/sportsbooks — List available sportsbooks with current status, required subscription tier, and book-specific capabilities. Covers 30+ books including Pinnacle and DraftKings."
---
