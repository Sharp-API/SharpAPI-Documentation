---
description: "Understand how sports betting arbitrage works — the math behind guaranteed-profit arbs, how SharpAPI detects them across sportsbooks, and practical staking strategies."
---
...
> **Tip:**
  Many sharp bettors prefer +EV over arb because accounts last longer and edges are often larger. See [EV Calculation](/en/concepts/ev-calculation) for the math behind +EV.

## Build an Arb Scanner

Ready to automate arb detection? See the [Arbitrage Scanner Example](/en/examples/arbitrage-scanner) for a complete Python implementation with Discord alerts.
