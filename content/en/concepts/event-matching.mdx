---
description: "How SharpAPI matches identical events across 30+ sportsbooks using canonical event IDs. Solves the problem of different sportsbook-specific event naming and identifiers."
---
