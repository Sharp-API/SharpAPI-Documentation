...
- **Fast updates** — lines move within seconds of game events; prices reflect current game state almost immediately
...
| Live odds update interval | 1–5 seconds | 15–60+ seconds |
