---
description: "Build a Discord or Telegram bot that alerts you to positive expected value (+EV) betting opportunities in real-time using SharpAPI SSE streaming. Full JavaScript example."
---
...
- [EV Calculation Concepts](/en/concepts/ev-calculation) - How SharpAPI calculates expected value
- [Arbitrage Scanner Example](/en/examples/arbitrage-scanner) - Similar bot for real-time arb detection
- [+EV Opportunities API](/en/api-reference/opportunities-ev) - Endpoint reference
