---
description: "SharpAPI provides real-time sports betting odds and Novig API integration from 42 sportsbooks, with +EV detection, no-vig fair odds, arbitrage alerts, and SSE streaming via REST API."
---

import { Cards, Callout } from 'nextra/components'

# SharpAPI — Novig API & Sports Betting Odds
...
- ProphetX
- Betfair
- **Novig** — commission-free no-vig exchange; fetch Novig API odds via a single SharpAPI endpoint

### Prediction Markets
- Polymarket
- Kalshi

**32 sportsbooks** with real-time odds aggregation, including exchanges and prediction markets.
...
| `GET /opportunities/low_hold` | [Low hold lines](/en/api-reference/opportunities-low-hold) | Pro+ |
