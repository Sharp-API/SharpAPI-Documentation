...
| **Sharp** | $399/mo | 1,000 | 0* | Real-time | All 30+ | + Priority Support |
...
- [Game State](/en/api-reference/gamestate) - Live scores aggregated across sportsbooks
- Dedicated support
...
| `GET /historical/odds/*` | No | No | No | No | Yes |
...
| Sharp/Enterprise | All | All 30+ supported books |
