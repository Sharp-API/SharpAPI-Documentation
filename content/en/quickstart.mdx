---
description: "Get started with SharpAPI in under 2 minutes. Make your first API call to fetch real-time sports betting odds with cURL, JavaScript, Python, or TypeScript examples."
---
...
2. **Get Your Key** - Copy your API key from the dashboard. It starts with `sk_live_`
...
Once you have a Pro subscription, you can find [+EV opportunities](/en/concepts/ev-calculation):
...
- [Get +EV Bets](/en/api-reference/opportunities-ev) - Find positive expected value opportunities
- [Find Arbitrage](/en/api-reference/opportunities-arbitrage) - Detect risk-free profit opportunities ([learn how arbs work](/en/concepts/arbitrage))
- [Low Hold Markets](/en/api-reference/opportunities-low-hold) - Find the tightest lines across books
- [Stream Live](/en/streaming/overview) - Real-time updates via SSE
- [TypeScript SDK](/en/sdks/typescript) - Full type safety and built-in streaming
- [Python SDK](/en/sdks/python) - Pydantic models and async support
- [Rate Limits](/en/authentication#rate-limits) - Understand usage limits
- [Pricing](/en/pricing) - Compare plans and features
...
This endpoint requires a higher tier. Check the [Pricing](/en/pricing) page for tier features.
</Callout>
