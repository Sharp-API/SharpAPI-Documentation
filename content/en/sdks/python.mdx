---
description: "Official SharpAPI Python SDK — install sharpapi from PyPI for typed access with Pydantic models, SSE streaming, async support, and full IDE autocomplete out of the box."
---
...
client.odds.comparison(event_id="nba_celtics_lakers_2026-02-08_b3")

# Batch lookup
client.odds.batch(event_ids=["nba_celtics_lakers_2026-02-08_b3", "nfl_bills_chiefs_2026-02-17_b2"])
```
...
# Single event
client.stream.event("nba_celtics_lakers_2026-02-08_b3")
```
