---
description: "Official SharpAPI TypeScript SDK — install @sharp-api/client from npm for typed access to all endpoints with SSE streaming, Zod validation, and full IDE autocomplete."
---
