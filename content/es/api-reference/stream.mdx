...
event: odds:update
id: evt_00042
data: {"odds":[{"id":"123456","odds_american":-150,"odds_decimal":1.667,"odds_probability":0.6,"line":null,"is_live":false,"timestamp":"2026-02-08T18:47:38Z"}],"count":1,"book":"draftkings","partial":false}
```
...
| `timestamp` | string | Hora ISO 8601 en que SharpAPI refrescó por última vez esta cuota a través de su pipeline — avanza en cada ciclo de ingesta. Es una señal de frescura del feed / actividad (igual que el `timestamp` de OpticOdds); NO es cuándo cambió el precio por última vez. Consulta [Entendiendo el campo `timestamp`](/es/concepts/pinnacle-odds-changed-at/). |
