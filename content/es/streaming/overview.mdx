...
| `odds:update` | Delta compacto — solo campos dinámicos (`id`, `odds_american`, `odds_decimal`, `odds_probability`, `line`, `is_live`, `timestamp`). Fusionar por `id` con el estado del snapshot. |
