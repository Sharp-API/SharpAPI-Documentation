...
- [EV Calculation Concepts](/concepts/ev-calculation) - How SharpAPI calculates expected value
- [Arbitrage Scanner Example](/examples/arbitrage-scanner) - Similar bot for real-time arb detection
- [+EV Opportunities API](/api-reference/opportunities-ev) - Endpoint reference
