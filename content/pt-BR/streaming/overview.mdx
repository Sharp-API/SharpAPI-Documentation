...
| `odds:update` | Delta compacto — apenas campos dinâmicos (`id`, `odds_american`, `odds_decimal`, `odds_probability`, `line`, `is_live`, `timestamp`). Faça merge por `id` no estado do snapshot. |
