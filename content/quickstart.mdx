...
Once you have a Pro subscription, you can find [+EV opportunities](/concepts/ev-calculation):
...
- [Find Arbitrage](/api-reference/opportunities-arbitrage) - Detect risk-free profit opportunities ([learn how arbs work](/concepts/arbitrage))
- [Low Hold Markets](/api-reference/opportunities-low-hold) - Find the tightest lines across books
- [Stream Live](/streaming/overview) - Real-time updates via SSE
- [TypeScript SDK](/sdks/typescript) - Full type safety and built-in streaming
- [Python SDK](/sdks/python) - Pydantic models and async support
