...
| `middles:detected` | New middle opportunity found (see [Middles Summary](/api-reference/opportunities-middles-summary) for aggregated stats) |
...
- **[TypeScript SDK](/sdks/typescript)** -- Built-in SSE client with type-safe event handlers
- **[Python SDK](/sdks/python)** -- Handler-based and iterator-based streaming patterns

## Example Projects

- [Arbitrage Scanner](/examples/arbitrage-scanner) -- Real-time arb detection with Discord alerts
- [Value Betting Bot](/examples/value-betting) -- +EV alert bot for Discord/Telegram
