...
| `snapshot_complete` | All initial data has been sent (WebSocket only) |
| `odds:update` / `odds_update` | Odds changed for a sportsbook |
| `odds_removed` | Odds removed by a sportsbook (WebSocket only) |
