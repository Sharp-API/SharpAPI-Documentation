...
Threshold filters: `min_ev` (default 2.0), `min_profit` (default 0.5) — filter out low-value opportunities server-side.
...
- **`odds_removed`** -- Odds removed by a sportsbook (requires `odds` channel)
